...
import org.eternity.step04_conceptual_contour.loan.Facility;
...
public class FacilityTest {
    ...
    public void 수수료_배분() {
        ...
        // 수수료 10원 납부
        SharePie repay = facility.distributeChange(Money.won(10));

        // 퍼실리티 지분에 따라 상환금 배분
        assertThat(repay.amountOf(companyA)).isEqualTo(Money.won(5));
        assertThat(repay.amountOf(companyB)).isEqualTo(Money.won(2));
        assertThat(repay.amountOf(companyC)).isEqualTo(Money.won(3));
    }
}
